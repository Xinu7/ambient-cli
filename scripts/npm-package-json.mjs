...
// published package declares only its real runtime externals (react, ink, undici, cross-spawn, yaml, unpdf — all pure-JS, no
// native build). The
  ...
  `${JSON.stringify(
    {
      ...
      dependencies: {
        ...
        "cross-spawn": pkg.dependencies["cross-spawn"],
